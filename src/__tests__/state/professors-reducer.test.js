...
import { getProfessorsLoading, getProfessorsSuccess } from '../../state/professors/professors-actions';

describe('Professors reducer', () => {
  it('sets the loading property to true when loading professors', () => {
    expect(professorsReducer(undefined, getProfessorsLoading()).loading).toBe(true);
  });
  ...
  it('sets loading to false and retrieves the list of professors', () => {
    ...
    const state = professorsReducer(undefined, getProfessorsSuccess(professors));
