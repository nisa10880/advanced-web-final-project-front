import { getProfessors, getProfessorsLoading, getProfessorsSuccess, getProfessorsFailure } from '../../state/professors/professors-actions';
import { api } from '../../api';
...
describe('Professors actions', () => {
  describe('getProfessors', () => {
    ...
    it('works properly', async () => {
      ...
      expect(dispatch).toHaveBeenNthCalledWith(2, getProfessorsSuccess(professors));
    });
